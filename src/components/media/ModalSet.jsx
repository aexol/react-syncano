  ...
  render () {
    ...
    return (
      <div className="ModalSet">
        <AddModal actions={actions} endpoint={add} fields={fields} initialData={initialDataAdd} isOpen={open === "add"} name={name} presetData={presetData} text={addText} toggle={toggle}/>
